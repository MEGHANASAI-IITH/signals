...
\item
The output of the python script in Problem \ref{prob:output} is the audio file Meghana-filtered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
Play the audio file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
