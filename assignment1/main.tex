...
Angular frequency of signal,\\
 ...
 $\omega$ = 2$\pi$$f$ = 2$\pi \cdot \left(50\right)$ = $100\pi$
 ...
 \end{equation}
 Average Power transferred to the resistor is given by :
\begin{equation}
	P_R = I^2(s) \cdot R\\
\end{equation}
Average Power transferred to the inductor is given by :
\begin{equation}
	P_L = I^2(s) \cdot \text{Re}(Z_L(s))\\
\end{equation}
Average Power transferred to the capacitor is given by :
\begin{equation}
	P_C = I^2(s) \cdot \text{Re}(Z_C(s))\\
\end{equation}
  Since the reactive components of inductor and capacitor have imaginary impedances, 
 \begin{align}
 	\text{Re}(Z_L) &= 0 \\
 	\text{Re}(Z_C) &= 0 
 \end{align}
...
\end{equation}
Impedence $Z$ is obtained by sustituting the numerical values from the ~\tabref{tab:my_label}:
 \begin{align}
 Z=31.728\hspace{0.2cm}\ohm
\end{align}	
