...
\textbf{Question:} 
Suppose the circuit in Exercise 7.18 (in Figure~\ref{fig:2})has a resistance of 15 Ω. Obtain the average power transferred to each element of the circuit, and the total power absorbed.\\
\\
...
\textbf{Solution: }
In  in Figure~\ref{fig:2} the following information is provided:
